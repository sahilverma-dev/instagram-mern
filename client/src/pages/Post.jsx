...
//   for(let i = 0;i<fakePostData.length;i++){
//     if(fakePostData[i].id == postID){
//         console.log(fakePostData[i])
//         post = fakePostData[i] 
...
/>
  ...
  <div className="flex items-center justify-between p-2">
    ...
    <div className="flex items-center gap-1">
      ...
      <button>
        <HeartIcon onClick={() => setIsLiked(!isLiked) } color={isLiked?"red":"black"} size={20} />
      </button>
      <button>
        <MenuIcon size={20} />
      </button>
